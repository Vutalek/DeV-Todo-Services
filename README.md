...
FastAPI-сервис для генерации структурированной Trello-задачи из свободного TODO-текста. Перед генерацией сервис ищет похожие исторические задачи в ChromaDB/BM25, добавляет их в контекст модели и возвращает `name`, `desc`, `label`, `prio`, `time`, `roadmap`, `column` и `deadline`.
