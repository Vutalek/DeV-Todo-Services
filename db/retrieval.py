...
from parse_data import RetrievalTask
import os
from parse_data import task_to_document, csv_to_tasks, load_tasks_to_chroma
...
tasks = csv_to_tasks(
    '/Users/ilya/TODO/db/chroma_db/GFG_FINAL.csv')
